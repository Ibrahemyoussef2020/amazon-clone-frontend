...
const storageIsLogged = localStorage.getItem('isLogged') !== null ? JSON.parse(localStorage.getItem('isLogged')): false
const storageUserInfo = localStorage.getItem('user') !== null ? JSON.parse(localStorage.getItem('user')): {
    userName:'',
    userEmail:'',
    userPassword:''
}
