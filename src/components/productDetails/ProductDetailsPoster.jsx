...
const ProductDetailsPoster = ({part}) => {
  ...
  return (
    <div className='flex !flex-nowrap justify-between items-center py-2 px-3 border border-solid border-[#ccc]'>
        ...
        <article className='hidden sm:flex items-end gap-2 pr-4'>
            <span className='py-1 px-2 bg-red-800 font-semibold text-white'>
                {discount} % off
            </span>
        ...
        <article className='hidden sm:flex items-center lg:pr-24'>
            ...
            <span className="ml-1 mt-2 text-[#555] ">List Price: 
                <span className="line-through"> EGP 1,600</span>
            </span>
            <p className="a-size-base mb-0 ml-1">
